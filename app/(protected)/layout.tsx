    ...
    <main className="apple-shell">
      <nav className="apple-nav px-4 py-3">
        <div className="max-w-6xl mx-auto flex items-center gap-2 md:gap-4 text-sm overflow-x-auto whitespace-nowrap">
          ...
          {user.role === 'ADMIN' ? <Link href="/dashboard" className="apple-btn-secondary py-1.5 px-3">Dashboard</Link> : null}
          ...
          {user.role === 'ADMIN' ? <Link href="/admin" className="apple-btn-secondary py-1.5 px-3">Admin</Link> : null}
